# b2wads OpenAPI Specification
[![Build Status](https://travis-ci.org/B2W-BIT/b2wads-api-docs.svg?branch=master)](https://travis-ci.org/B2W-BIT/b2wads-api-docs)
...
6. If you did everything correct, https://b2w-bit.github.io/b2wads-api-docs/ will lead to your new docs
...
- Documentation(ReDoc): https://b2w-bit.github.io/b2wads-api-docs/
- SwaggerUI: https://b2w-bit.github.io/b2wads-api-docs/swagger-ui/
- Look full spec:
    + JSON https://b2w-bit.github.io/b2wads-api-docs/swagger.json
    + YAML https://b2w-bit.github.io/b2wads-api-docs/swagger.yaml
- Preview spec version for branch `[branch]`: https://b2w-bit.github.io/b2wads-api-docs/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://b2w-bit.github.io/b2wads-api-docs/ with url from the message: `Server started <url>`
